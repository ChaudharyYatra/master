...
<script>//passbook_img doc   
 var count = $('#seat_count_add').val(); 
 //for(var i=1; i<count; i++){    
    function encodeImgtoBase64traveller_img(element) {var img_id =$(element).attr('attr_id');
...
<script>
    ...
    var final_total= parseInt(ftotal) + parseInt(etotal) + parseInt(gtotal) + parseInt(mtotal) + parseInt(ltotal);
            ...
            if(attrval=="yes"){
                ...
                newvar_1 += Number(new_div_val);
                    if(Number(newvar_1) === newvar_1 && newvar_1 % 1 === 0){
                        ...
                        $("#booknow_submit").prop('disabled', true);
                        $('#room1_error_msg').empty().text('This room must contain total one(1) or multiple of one members compulsory');
                    }
            }
...
//--------------------------------------------------------------------------------------------  
// This code for calculating room calculation but can't use this we use above each function code
    // var adult_Plus = 0;
    // var adult_Plus_90 =  0;
    // var room_per_1 =0;
    // var room_per_2 =0;
// if(parseInt($("#twobed_oneroom_cost_adult").val()) >0){
//     var adult_Plus = parseInt($("#twobed_oneroom_cost_adult").val()) ;
//     var room_per_1 = adult_Plus/2;
// }
// // alert(room_per_1);

// if(parseInt($("#twobed_oneroom_count_90").val()) >0){
//     var adult_Plus_90 = parseInt($("#twobed_oneroom_count_90").val()) ;
//     var room_per_2 = adult_Plus_90/2;
// }
// // alert(room_per_2);

// var addition_adult_90 = room_per_1 + room_per_2;
// alert(addition_adult_90);
//-------------------------------------------------------------------------------------------- 
...
<script>
$(document).ready(function () {
$('#suugestion_add').validate({ // initialize the plugin
    errorPlacement: function($error, $element) {
    $error.appendTo($element.closest("div"));
  },
    rules: {
...
<script>
$(document).ready(function () {
$('#suugestion_edit').validate({ // initialize the plugin
    errorPlacement: function($error, $element) {
    $error.appendTo($element.closest("div"));
  },
  rules: {
...
<!-----------------validations------ vehicle details ----------------------->
<script>
$(document).ready(function () {
$('#add_vehicle_details').validate({ // initialize the plugin
    errorPlacement: function($error, $element) {
    $error.appendTo($element.closest("div"));
  },
    rules: {
        ...
        vehicle_insideone_image: {
            required: true,
        },
        vehicle_insidetwo_image: {
            required: true,
        }
    ...
    messages :{
        ...
        vehicle_brand : {
            required : "Please Select Vehicle Brand",
        },
		seat_capacity : {
            required : "Please enter Seat Capacity",
        },
        insurance_number : {
		...
		registration_number: {       
                required: "Please enter RTO Registration Number",   
        },
        luggage_capacity: {       
                required: "Please enter Luggage Carring Capacity(Kg)",   
        },
        total_kilometer: {       
                required: "Please enter Total kilometer(reading)",   
        },
        vehicle_front_image: {       
                required: "Please Select Vehicle Image(Front)",   
        },
        vehicle_back_image: {       
                required: "Please Select Vehicle Image(back)",   
        },
        vehicle_left_image: {       
                required: "Please Select Vehicle Image(left)",   
        },
        vehicle_right_image: {       
                required: "Please Select Vehicle Image(right)",   
        },
        vehicle_insideone_image: {       
                required: "Please Select Vehicle Image(insideone)",   
        },
        vehicle_insidetwo_image: {       
                required: "Please Select Vehicle Image(insidetwo)",   
        }
...
<!-- jquery validation on vehicle details -->

<!-----------------validations------ vehicle details ----------------------->
<script>
$(document).ready(function () {
$('#edit_vehicle_details').validate({ // initialize the plugin
    errorPlacement: function($error, $element) {
    $error.appendTo($element.closest("div"));
  },
    rules: {
...
<script>
$(document).ready(function () {
$('#add_vehicle_driver').validate({ // initialize the plugin
    errorPlacement: function($error, $element) {
    $error.appendTo($element.closest("div"));
  },
    rules: {
    ...
    messages :{
        ...
        "licence_type[]" : {
            required : "Please Select Licence Type",
        },
        licence_image_front : {
            required : "Please Select Upload licence Image(front)",
        },
		licence_image_back : {
            required : "Please Select Upload licence Image(back)",
        },
        aadhaar_image_front : {
            required : "Please Select Upload Aadhaar Image(front)",
        },
		aadhaar_image_back: {       
                required: "Please Select Upload Aadhaar Image(back)",   
        },
        profile_image: {       
...
<script>
$(document).ready(function () {
$('#edit_vehicle_driver').validate({ // initialize the plugin
    errorPlacement: function($error, $element) {
    $error.appendTo($element.closest("div"));
  },
    rules: {

...
<section class="content">
    <div class="container-fluid">
        <div class="row">
          <?php 
            if($arr_data['driver_kilometer_update_count'] >0 ){

          ?> 
          <div class="col-lg-3 col-6">
            <a class="underline" href="<?php echo base_url(); ?>vehicle_driver/kilometer_update/index">
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $arr_data['driver_kilometer_update_count']; ?></h3>

                <p>kilometer Update Count</p>
              </div>
              <div class="icon">
          ...
          <?php 
            if($arr_data['disel_tour_expenses_count'] >0 ){

          ?> 
          <div class="col-lg-3 col-6">
            <a class="underline" href="<?php echo base_url(); ?>vehicle_driver/disel_tour_expenses/index">
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php echo $arr_data['disel_tour_expenses_count']; ?></h3>

                <p>Disel Expenses Count</p>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>

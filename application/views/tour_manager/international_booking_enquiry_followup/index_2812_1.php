                          ...
                          <div class="col-md-12">
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="next_followup_date" id="next_followup_date" value="<?php if(isset($domestic_followup_info['next_followup_date'])){ echo $domestic_followup_info['next_followup_date'];}?>" required>

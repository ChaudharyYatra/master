                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <?php if($info['status']== 'approved'){?>
                      <td>
                      <a data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $i; ?>" data-bs-whatever="Form"><button type="button" class="btn btn-primary btn-sm" class="dropdown-item">View Details</button> </a>
                      </td>
                    <?php } else { ?>
                      <td>
                    <a data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $i; ?>" data-bs-whatever="Form"><button type="button" class="btn btn-primary btn-sm" class="dropdown-item" disabled>View Details</button> </a>
                    </td>
                    <?php } ?>

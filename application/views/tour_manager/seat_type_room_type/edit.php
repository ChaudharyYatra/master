                ...
                <form method="post" enctype="multipart/form-data" id="seat_type_room_type">
                    <div class="card-body card-bg">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control seattype_count" name="seperate_seat" id="seperate_seat" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['seperate_seat'];} ?>" placeholder="Enter Adult Seates" onkeyup="adult_count()" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control seattype_count" name="child_no_seat_needed" id="child_no_seat_needed" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['child_no_seat_needed'];} ?>" placeholder="Enter Child No Seats" onkeyup="child_noseat_count()" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate1" attr-per="<?php echo $arr_package_info['single_seat_cost']; ?>" name="onebed_oneroom_cost_adult" id="onebed_oneroom_cost_adult" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['onebed_oneroom_cost_adult'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate1" attr-per="<?php $pcost = $arr_package_info['single_seat_cost']; $final_cost=$pcost*90/100; echo round($final_cost); ?>" name="onebed_oneroom_cost_90" id="onebed_oneroom_cost_90" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['onebed_oneroom_cost_90'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate1" attr-per="<?php $p_60_cost = $arr_package_info['single_seat_cost']; $final_60_cost=$p_60_cost*60/100; echo round($final_60_cost); ?>" name="onebed_oneroom_count_60" id="onebed_oneroom_count_60" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['onebed_oneroom_count_60'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate1" attr-per="<?php $p_40_cost = $arr_package_info['single_seat_cost']; $final_40_cost=$p_40_cost*40/100; echo round($final_40_cost); ?>"  name="onebed_oneroom_40" id="onebed_oneroom_40" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['onebed_oneroom_40'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate1" attr-per="<?php $p_40_cost = $arr_package_info['single_seat_cost']; $final_40_cost=$p_40_cost*0/100; echo round($final_40_cost); ?>" name="onebed_oneroom_0" id="onebed_oneroom_0" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['onebed_oneroom_0'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate3" attr-per="<?php echo $arr_package_info['three_four_sharing_cost']; ?>" name="threebed_oneroom_cost_adult" id="threebed_oneroom_cost_adult" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['threebed_oneroom_cost_adult'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate3" attr-per="<?php $pcost = $arr_package_info['three_four_sharing_cost']; $final_cost=$pcost*90/100; echo round($final_cost); ?>" name="threebed_oneroom_count_90" id="threebed_oneroom_count_90" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['threebed_oneroom_count_90'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate3" attr-per="<?php $p_40_cost = $arr_package_info['three_four_sharing_cost']; $final_40_cost=$p_40_cost*40/100; echo round($final_40_cost); ?>" name="threebed_oneroom_count_40" id="threebed_oneroom_count_40" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['threebed_oneroom_count_40'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate3" attr-per="<?php $p_40_cost = $arr_package_info['three_four_sharing_cost']; $final_40_cost=$p_40_cost*0/100; echo round($final_40_cost); ?>" name="threebed_oneroom_count_0" id="threebed_oneroom_count_0" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['threebed_oneroom_count_0'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate4" attr-per="<?php echo $arr_package_info['three_four_sharing_cost']; ?>" name="fourbed_oneroom_cost_adult" id="fourbed_oneroom_cost_adult" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['fourbed_oneroom_cost_adult'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate4" attr-per="<?php $pcost = $arr_package_info['three_four_sharing_cost']; $final_cost=$pcost*90/100; echo round($final_cost); ?>" name="fourbed_oneroom_count_90" id="fourbed_oneroom_count_90" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['fourbed_oneroom_count_90'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate4" attr-per="<?php $p_40_cost = $arr_package_info['three_four_sharing_cost']; $final_40_cost=$p_40_cost*40/100; echo round($final_40_cost); ?>" name="fourbed_oneroom_count_40" id="fourbed_oneroom_count_40" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['fourbed_oneroom_count_40'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <input type="text" class="form-control hotel_rate4" attr-per="<?php $p_40_cost = $arr_package_info['three_four_sharing_cost']; $final_40_cost=$p_40_cost*0/100; echo round($final_40_cost); ?>" name="fourbed_oneroom_count_0" id="fourbed_oneroom_count_0" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['fourbed_oneroom_count_0'];} ?>" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="total_travaller_count" id="total_travaller_count" placeholder="total_travaller_count" readonly oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="<?php if(!empty($seat_type_room_type)){ echo $seat_type_room_type['total_travaller_count'];} ?>">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?php echo $module_all_traveller_info; ?>/edit/<?php echo $enquiry_id;?>/1"><button type="button" class="btn btn-warning" name="back_btn">Back</button></a>

                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="request_more_fund" id="request_more_fund" placeholder="Enter More Fund Amt" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"><?php echo $packages_data_info['more_fund_amt'];?></textarea>
                                </div>
                            </div>
                        <?php } ?>
                </div>

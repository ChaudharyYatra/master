...
<!-- ======================================================================= -->
<!-- inter seat type and room type add -->
<script>
    $(document).ready(function () {
        $("#inter_booknow_submit").prop('disabled', true);
        var f_count = '';
        var e_count = '';
        var g_count = '';
        var m_count = '';
        ...
        $(".inter_b_r_count").on('keyup',function () {
    ...
    var inputString_one = $("#seat_count").val();
            if(final_total != inputString_one){
                ...
                $("#inter_booknow_submit").prop('disabled', false)
            }
            });
                // alert(inputString);
                // alert(inputString_one);
...
<script>
    $(document).ready(function () {
        $("#inter_bustype_seattype_submit").prop('disabled', true);
        var f_count = '';
        var e_count = '';
        var g_count = '';
        var m_count = '';
        ...
        $(".edit_inter_b_r_count").on('keyup',function () {
            var f_count= $("#onebed_oneroom_count").val()
            var e_count= $("#twobed_oneroom_count").val();
            var g_count= $("#threebed_oneroom_count").val();
            var m_count= $("#fourbed_oneroom_count").val();
    ...
    var inputString_one = $("#seat_count").val();
            if(final_total != inputString_one){
                ...
                $("#inter_bustype_seattype_submit").prop('disabled', false)
            }
            });
                // alert(inputString);
                // alert(inputString_one);
...
<script>
    $(document).ready(function () {
        $("#bustype_seattype_submit").prop('disabled', true);
        var f_count = '';
        var e_count = '';
        var g_count = '';
        var m_count = '';
    ...
    var inputString_one = $("#seat_count").val();
            if(final_total != inputString_one){
                ...
                $("#bustype_seattype_submit").prop('disabled', false)
            }
                // alert(inputString);
                // alert(inputString_one);
            });
...
<!-- inter seat type and room type add  and edit-->

<!-- =========Bus Seats Type Selection=  add and edit =============== -->
...
<script>
    $(document).ready(function () {
        ...
        $(".inter_seattype_count").on('keyup',function () {
...
<script>
    $(document).ready(function () {
        ...
        $(".edit_seattype_count").on('keyup',function () {
            var f_count= $("#seperate_seat").val()
            var e_count= $("#child_seperate_seat").val();
            var g_count= $("#two_child_share_one_seat").val();
            var m_count= $("#child_no_seat_needed").val();
...
<script>
    ...
    $("#total_busseattype").val(final_total);
            ...
            if(final_total == inputString_one && g_count % 2 == 0 && travaller_room_count == final_total){
                $("#booknow_submit").prop('disabled', false)
            }
            else{
                $("#booknow_submit").prop('disabled', true)
  ...
  $(document).ready(function(){
    ...
    // ------------
        ...
        var d_count = '';
            ...
            if(room_travaller_count == inputString_one && g_even_no_count % 2 == 0 && inputString_one == room_travaller_c){
                $("#booknow_submit").prop('disabled', false)
            }
            else{
                $("#booknow_submit").prop('disabled', true)
...
<script type='text/javascript'>
 ...
 $('#total_travaller_3').val(room_seat_c);
        ...
        var d_count = '';
            ...
            // alert(final_total+'final_total');
            // alert(inputString_one+'total_travaller_count');
            // alert(room_travaller_c+'seat_count');
            if(room_travaller_count==inputString_one && inputString_one == room_travaller_c && g_even_no_count % 2 == 0){
                $("#booknow_submit").prop('disabled', false)
            }
            else{
                $("#booknow_submit").prop('disabled', true)

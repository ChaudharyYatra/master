        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" enctype="multipart/form-data" id="add_internationalenquiry">
                <div class="card-body">
                 <div class="row">
					 <div class="col-md-6">
					 ...
					 <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                              <div class="form-group">
                                ...
                                &nbsp;&nbsp;<input type="radio" name="gender" id="gender" value="Female" required="required">&nbsp;&nbsp;Female <br>
                              </div>
                      </div>
                     ...
                     <div class="col-md-6">
                              <div class="form-group">
                                <label>Tour number</label>
                                  <select class="form-control" name="packages" id="packages" onchange='CheckColors(this.value); 
                                  this.blur();' onfocus='this.size=6;' onblur='this.size=1;'>
                                    ...
                                    <?php foreach($international_packages_data as $international_packages_data_value){ ?> 
                                        <option value="<?php echo $international_packages_data_value['id'];?>"><?php echo $international_packages_data_value['tour_number'];?></option>
                                    <?php } ?>
                                  </select>
                              </div>
                      </div>

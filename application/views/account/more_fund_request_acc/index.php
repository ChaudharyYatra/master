              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Package Type</th>
                    <th>Tour No / Name</th>
                    <th>Request Amount For More Fund by Tour manager</th>
                    <th>Approved Amount by Tour Operation manager</th>
                  ...
                  <tr>
                    ...
                    <td><?php echo $info['tom_approval_amt'] ?></td>
                    <td><?php echo $info['status'] ?></td>

                  
                  <?php if($info['send']== 'yes'){?>
                      <td>
                      <a data-bs-toggle="modal" data-bs-target="#exampleModalone<?php echo $i; ?>" data-bs-whatever="Form"><button type="button" class="btn btn-primary btn-sm" class="dropdown-item">View</button> </a>
                      </td>
                  ...
                  <?php } else{ ?>
                    ...
                    <?php } else { ?>
                      <td>
                          <a data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $i; ?>" data-bs-whatever="Form"><button type="button" class="btn btn-primary btn-sm" class="dropdown-item" disabled>Send</button> </a>
                      </td>
                    <?php } ?>

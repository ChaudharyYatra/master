...
<!-- add more add room multiple -->

<script>

    var i=1;
    $('#add_more_room').click(function() {
       // alert('hhhh');
            i++;
var structure = $(` <style> .hotel_add_room_under{width:97%; border-top: 1px solid #000;} </style>
                  
                    <div class="row" id="new_row`+i+`">
                    <input class="form-control" type="hidden" name="assign[]" value="`+i+`">
                    <hr class="hotel_add_room_under">

                    <div class="col-md-2">
                      <div class="form-group">
                        <label>Room Number</label><br>
                        <input class="form-control" type="text" name="room_number[]" required="required">
                      </div>
                    </div>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="floor_number[]" required="required">
                      </div>
                    </div>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="occupancy[]" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required="required">
                      </div>
                    </div>
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        ...
                        <input type="checkbox" name="amenities`+i+`[]" value="TV">TV
                        &nbsp;&nbsp;<input type="checkbox" name="amenities`+i+`[]" value="WIFI">&nbsp;&nbsp; WIFI
                        &nbsp;&nbsp;<input type="checkbox" name="amenities`+i+`[]" value="Mini-Fridge">&nbsp;&nbsp; Mini-Fridge
                      </div>
                      </div>

                            ...
                            <div class="form-group">
                              ...
                              <select class="select_css" name="hotel_type" id="hotel_type">
                                ...
                                <?php foreach($hotel_type_info as $hotel_type_info_value){ ?> 
                                    <option value="<?php echo $hotel_type_info_value['id'];?>" <?php if(isset($edit_booking_basic_info['hotel_type'])){if($hotel_type_info_value['id'] == $edit_booking_basic_info['hotel_type']) {echo 'selected';}}?>><?php echo $hotel_type_info_value['hotel_type_name'];?></option>
                                <?php } ?>
                              </select>
                            </div>
                          </div>

                          ...
                          <form method="post" action="<?php echo $module_url_path;?>/received_amt_from_acc" enctype="multipart/form-data">
                            <div class="col-md-12">
                              <div class="row">
                                ...
                                <?php if($info['Received_amt_status'] != 'no'){?>
                                <div class="col-md-6 mb-2">
                                ...
                                <?php } else {?>
                                  <div class="col-md-6 mb-2">
                                    <label class="col-form-label">Received Amount From Accountant</label> 
                                    <input type="text" class="form-control" name="received_amt_from_account" id="received_amt_from_account" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                                  </div>
                                <?php } ?>
                              </div>
                            </div>

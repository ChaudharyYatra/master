                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!-- </td>  -->
                     ...
                     <?php if($count > 0){
                      ...
                      ?>
                      <a href="<?php echo $module_url_path_followup;?>/index/<?php echo $info['id']; ?>"><button type="button" class="btn btn-primary btn-sm btn_follow" class="dropdown-item">followup</button></a>
                     
                    
                    <?php        
                          }else{
                      ?>
                     <h6>No followup Taken</h6>
                    </td>
                    <?php } ?>

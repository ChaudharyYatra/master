        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="<?php echo $module_url_path; ?>/index/<?php echo $id; ?>"><button class="btn btn-primary">List</button></a>
                    ...
                    <div class="col-md-5">
                      ...
                      <div class="col-md-5">
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="available_seats[]" id="available_seats" placeholder="Enter Available Seats" required>
                      ...
                      <!-- <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="single_seat_cost[]" id="available_seats" placeholder="Enter Single Seat Cost" required>
                              </div>
                      </div>
                      <div class="col-md-2">
                              <div class="form-group">
                                <label>Twin Sharing Cost</label>
                                <input type="number" class="form-control" name="twin_seat_cost[]" id="available_seats" placeholder="Enter Twin Sharing Cost" required>
                              </div>
                      </div>
                      <div class="col-md-2">
                              <div class="form-group">
                                <label>3/4 Sharing Cost</label>
                                <input type="number" class="form-control" name="three_four_sharing_cost[]" id="available_seats" placeholder="Enter 3/4 Sharing Cost" required>
                              </div>
                      </div>     -->
                      <div class="col-md-2">
                            <div class="form-group">

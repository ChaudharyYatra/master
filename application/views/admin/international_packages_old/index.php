                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu" role="menu">
                          ...
                          <a href="<?php echo $module_url_path_dates;?>/add/<?php echo $info['id']; ?>" ><button class="dropdown-item">Add Dates</button></a>
							<a href="<?php echo $module_url_path_iternary;?>/add/<?php echo $info['id']; ?>" ><button class="dropdown-item">Add Iternary</button></a>

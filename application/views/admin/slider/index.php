              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <img src="<?php echo base_url(); ?>uploads/slider/<?php echo $info['image_name']; ?>" width="70px;" height="30px;" alt="Slider Image">
                    </td>
                    <td>
                        <?php 
                    ...
                    <td>
					   ...
					   echo rtrim($aid, '='); ?>" onclick="return confirm_action(this,event,'Do you really want to delete this record?');"><i class="fa fa-trash" aria-hidden="true" style="color:red";></i></a>

            ...
            <ol class="breadcrumb float-sm-right">
              ...
              &nbsp;&nbsp;
                <?php
                    ...
                    { 
                        ?>
                    <a href="<?php echo $module_url_path;?>/add_new_cust_instruction/<?php echo $packages_info['id']; ?>" title="Add"><button class="btn btn-primary">Add New Instruction</button></a>
                <?php } ?>
            </ol>
          </div>
        </div>
              ...
              <form method="post" enctype="multipart/form-data" id="edit_package">
                <div class="card-body">
                  <div class="row">
                    ...
                    <input type="hidden" readonly class="form-control" name="cust_intr_attachment_id" id="cust_intr_attachment_id" value="<?php echo $arr_data3['id'] ?>" required="required">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <?php if(!empty($arr_data_main['image_name'])){ ?>
                          <img src="<?php echo base_url(); ?>uploads/cust_instraction/<?php echo $arr_data_main['image_name']; ?>" width="50%">
                          <input type="hidden" name="old_img_name" id="old_img_name" value="<?php echo $arr_data_main['image_name']; ?>">
                        <?php } ?>

                        <?php if(!empty($arr_data_main['image_name'])){ ?>
                            <a class="btn-link pull-right text-center" download="" target="_blank" href="<?php echo base_url(); ?>uploads/cust_instraction/<?php echo $arr_data_main['image_name']; ?>">Download</a>
                  ...
                  <div class="row" id="main_row">
                    ...
                    { 
                      ...
                      <input type="hidden" readonly class="form-control" name="cust_intr_id[]" id="cust_intr_id" placeholder="Enter tour number" value="<?php echo $info['id'] ?>" required="required">
                    ...
                    <div class="col-md-2 mt-4">
                      <div class="form-group">
                        <a onclick="return confirm('Are You Sure You Want To Delete This Record? ')" href="<?php echo $module_url_path;?>/delete/<?php echo $info['id']; ?>" title="delete"><button value="<?php echo $info['id']; ?>" class="btn btn-primary delete_instruction_cust">Delete</button></a>
                      </div>
                    </div>

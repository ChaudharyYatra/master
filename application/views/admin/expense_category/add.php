        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" enctype="multipart/form-data" id="add_expense_category">
                <div class="card-body">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    <label>Expense Category</label>
                      <input type="text" class="form-control" name="expense_category[]" id="expense_category" placeholder="Enter Expense Category" required>

                 ...
                 <div class="row">
					 <div class="col-md-6">
                              <div class="form-group">
                                <label>Arrange Number</label>
                                <input type="text" class="form-control" name="arrange_id" id="arrange_id" placeholder="Enter Arrange Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required="required" value="<?php echo $info['arrange_id']; ?>">
                              </div>
                        </div>

              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php  
                   ...
                   { 
                    $enq_id=$info['general_enquiry_id'];
                    $query=$this->db->query("select * from general_enquiries_followup where general_enquiry_id=$enq_id");
                  ...
                  <tr>
                    ...
                    <!-- <td> -->
                        ...
                        <!-- <a href="<?php //echo $module_url_booking_basic_info;?>/add/<?php //echo $info['general_enquiry_id']; ?>"><button type="button" class="btn btn-primary btn-sm btn_follow" class="dropdown-item">Booking</button></a> -->
                        <?php //} ?>
                    </td>
                    <!-- <td>
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="row">
                              <div class="col-md-6 mb-3">
                                ...
                                <input type="hidden" name="enquiry_id" id="enquiry_id" value="<?php if(isset($info['id'])){ echo $info['general_enquiry_id'];}?>">
                              </div>
                              <div class="col-md-6 mb-3">

            ...
            <div class="card">
              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $info['about_us'] ?></td>
                    <td><?php echo $info['years_experiences'] ?></td>
                    <td><?php echo $info['tour_packages'] ?></td>
                    <td><?php echo $info['happy_customers'] ?></td>
                    <td><?php echo $info['award_winning'] ?></td>

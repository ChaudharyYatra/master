            ...
            <div class="card">
              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $info['rules'] ?></td>
                    <td><a class="btn-link pull-right text-center" download="" href="<?php echo base_url(); ?>uploads/seat_reservation_rules/<?php echo $info['pdf']; ?>">Download</a></td>
                    <td>
                        <?php 

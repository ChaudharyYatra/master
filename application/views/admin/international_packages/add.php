        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" enctype="multipart/form-data" id="add_internationalpackage">
                <div class="card-body">
                 <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" style="width: 100%;" name="academic_year" id="academic_year" required="required">
                              ...
                              <!-- <span><?php //echo form_error('academic_year'); ?></span> -->
                          </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="select_css" name="package_type" id="package_type">
                            ...
                            <option value="Custom Domestic Package">Custom Domestic Package</option>
                            <option value="Custom International Package">Custom International Package</option>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="file" name="image_name" id="image_name_international" required="required">
                    ...
                    <span class="text-danger" id="img_size" style="display:none;">Image Size Should Be Less Than 2 MB.</span>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            <label>Upload Image</label><br>
                            <input type="file" name="international_package_full_image" id="international_full_image_name" required="required">

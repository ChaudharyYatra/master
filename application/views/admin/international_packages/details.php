              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>Image</th>
                    <td><img src="<?php echo base_url(); ?>uploads/international_packages/<?php echo $info['image_name']; ?>" width="70px;" height="30px;" alt="Slider Image"></td> 
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-one-terms_conditions-tab" data-toggle="pill" href="#custom-tabs-one-terms_conditions" role="tab" aria-controls="custom-tabs-one-terms_conditions" aria-selected="false">Terms Conditions</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <div class="tab-pane fade show" id="custom-tabs-one-iternary" role="tabpanel" aria-labelledby="custom-tabs-one-iternary-tab">
                    <?php echo $info['iternary']; ?>
                  </div>

            ...
            <div class="card">
              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $info['train_name'] ?></td>
                    <td><?php echo $info['train_number'] ?></td>
                    <td><?php echo $info['train_boarding_station'] ?></td>
                    <td><?php echo $info['train_arrival_station'] ?></td>
                    <td>
                        <?php 

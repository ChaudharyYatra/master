            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
               <?php
                   ...
                   { 
                     ?>
              <form method="post" enctype="multipart/form-data" id="edit_gallery">
                <div class="card-body">
                 <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="file" name="image_name" id="image_name_gallery" accept="image/*">
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <?php if(!empty($info['image_name'])){ ?>
                                      <img src="<?php echo base_url(); ?>uploads/gallery/<?php echo $info['image_name']; ?>" width="50%">

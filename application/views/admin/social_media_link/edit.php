            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
               <?php
                   ...
                   { 
                     ?>
              <form method="post" enctype="multipart/form-data" id="edit_socialmedia" id="edit_gallery">
                <div class="card-body">
                 <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                            <label>Social Media Link</label>
                            <input type="text" class="form-control" name="social_media_link" id="social_media_link" placeholder="Enter Social Media Link" required="required" value="<?php echo $info['social_media_link']; ?>">
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="file" name="image_name" id="image_name_socials" accept="image/*">
                            <br>
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <?php if(!empty($info['image_name'])){ ?>
                                      <img src="<?php echo base_url(); ?>uploads/social_media_link/<?php echo $info['image_name']; ?>" width="50%">

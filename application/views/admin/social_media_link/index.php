            ...
            <div class="card">
              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo $info['social_media_link'] ?></td>
                    <td>
                      <img src="<?php echo base_url(); ?>uploads/social_media_link/<?php echo $info['image_name']; ?>" width="70px;" height="30px;" alt="Website Logo">
                    </td>
                    <td>
                        <?php 

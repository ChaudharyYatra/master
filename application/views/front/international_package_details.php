                    ...
                    <div class="trend-content-main p-4 pb-2">
                        <div class="trend-content">
                            ...
                            <p class="mb-3 text_justify">
                                ...
                                <?php if(!empty($package_details_value['inclusion_img'])) { ?><img src="<?php echo base_url(); ?>uploads/international_inclusion_img/<?php echo $package_details_value['inclusion_img']; ?>" alt="image" class="w-100 rounded" >
                                    <?php }?>
                                </div>
                            </p>
                        </div>
                    ...
                    <div class="trend-content-main p-4 pb-2">
                        <div class="trend-content">
                            ...
                            <p class="mb-3 text_justify">
                                ...
                                <div class="description-images mb-4 pack-details">
                                <?php if(!empty($package_details_value['tc_img'])) { ?><img src="<?php echo base_url(); ?>uploads/international_tc_img/<?php echo $package_details_value['tc_img']; ?>" alt="image" class="w-100 rounded" >
                                    <?php }?>
                                </div>
                            </p>
                        </div>

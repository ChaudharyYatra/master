    ...
    <div class="page-cover pt-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="box-shadow p-3 rounded"><img src="images/trending/trending3.jpg" alt="Image" class="w-100 rounded"></div>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="blog-author-item">
                                <div class="row d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <h3 class="title pink"><a href="#">About Author <span class="fst-italic d-block">Graphic Designer</span></a></h3>

        ...
        <div class="breadcrumb-outer">
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <h1 class="mb-3">Our Guide</h1>
                    <nav aria-label="breadcrumb" class="d-block">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Our Guide</li>
                        </ul>
                    </nav>
                </div>
            </div>
            ...
            <div class="about-image-box">
                <div class="row d-flex align-items-center justify-content-between">
                    <div class="col-lg-6 mb-4 pe-4">
                        <div class="about-image1 overflow-hidden rounded">
                    ...
                    <div class="col-lg-6 mb-4 ps-4">
                        <div class="about-content text-center text-lg-start mb-4">
                            <h4 class="theme d-inline-block mb-0">Pefect Team</h4>
                            <h2 class="mb-2">Our Experience Guides</h2>
                            <p class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco</p>
                            <div class="about-listing border-b mb-2 pb-2">
                                <h5 class="mb-1"><i class="icon-location-pin theme"></i> Expert Team Guide</h5>
                                <p class="mb-0">Enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            </div>
                            <div class="about-listing border-b mb-2 pb-2">
                                <h5 class="mb-1"><i class="icon-briefcase theme"></i> Correct Directions</h5>
                                <p class="mb-0">Enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            </div>
                            <div class="about-listing">
                                <h5 class="mb-1"><i class="icon-folder theme"></i> Save Money & Time</h5>
                                <p class="mb-0">Enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 mb-4">
                    <div class="section-title text-lg-start text-center">
                        ...
                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<br><br>

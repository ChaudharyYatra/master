...
<section class="trending pt-6 pb-0 bg-lgrey package_list">
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-lg-8">
                <div class="list-results d-flex align-items-center justify-content-between">
                    ...
                    <div class="click-menu d-flex align-items-center justify-content-between">
                        <div class="sortby d-flex align-items-center justify-content-between ml-2">
                            <select class="niceSelect" name="filter_val_cat_sub" id="filter_val_cat_sub">
                ...
                <div class="destination-list">
                    ...
                    <?php foreach($packages_data as $pack_list_data){ ?>
                    <div class="trend-full bg-white rounded box-shadow overflow-hidden p-4 mb-4">
                        <div class="row">
                            <div class="col-lg-4 col-md-3">
                               <div class="trend-item2 rounded">
                                    <a href="#" style="background-image: url(<?php echo base_url();?>uploads/packages/<?php echo $pack_list_data['image_name'];?>);"></a>
                                     <div class="color-overlay"></div>
                                </div> 
                            </div>
                            <div class="col-lg-5 col-md-6">
                                <div class="trend-content position-relative text-md-start text-center">
                                    <small><span class="mb-0">Tour Duration :</span> <?php echo $pack_list_data['tour_number_of_days'];?></small>
                                    <h3 class="mb-1"><a href="<?php echo base_url(); ?>packages/package_details/<?php echo $pack_list_data['id']; ?>"><?php echo $pack_list_data['tour_title'];?></a></h3>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3">
                                <div class="trend-content text-md-end text-center">
                                    <div class="rating">
                                    <?php if($pack_list_data['rating']=='1') { ?>
                                    <span class="fa fa-star checked"></span>
                                    <?php }
                                    if($pack_list_data['rating']=='2') {
                                    ?>
                                    <span class="fa fa-star checked"></span>
                                    <span class="fa fa-star checked"></span>
                                    <?php }
                                    if($pack_list_data['rating']=='3') {
                                    ?>
                                    <span class="fa fa-star checked"></span>
                                    <span class="fa fa-star checked"></span>
                                    <span class="fa fa-star checked"></span>
                                    <?php }
                                    if($pack_list_data['rating']=='4') {
                                    ?>
                                    <span class="fa fa-star checked"></span>
                                    <span class="fa fa-star checked"></span>
                                    <span class="fa fa-star checked"></span>
                                    ...
                                    <div class="trend-price my-2">
                                        ...
                                        <h3 class="mb-0"><i  class="fa fa-inr" aria-hidden="true" style="font-size:15px"></i><?php echo $pack_list_data['cost'];?></h3>
                                    </div>
                                    <a href="<?php echo base_url(); ?>packages/package_details/<?php echo $pack_list_data['id']; ?>" class="nir-btn">View Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 pe-lg-4">
                <div class="sidebar-sticky">
                    <div class="list-sidebar">
                        ...
                        <div class="sidebar-item mb-4 p_list_price_range">

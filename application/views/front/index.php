                            ...
                            <div class="new-trend term-btn bg-theme white px-3 py-2 rounded">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-center">
                                        ...
                                        <a data-toggle="tab" class="nir-btn term-btn fw-bold btn-width white" href="<?php echo base_url();?>international_packages/booking_enquiry/<?php echo $international_packages_value['id']; ?>" class="bordernone">Itinerary</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">

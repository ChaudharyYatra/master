                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-3">
                               <div class="trend-item2 rounded">
                                    <a href="#" style="background-image: url(<?php echo base_url(); ?>uploads/package_mapping/<?php echo $pack_list_data['image_name'];?>);"></a>
                                     <div class="color-overlay"></div>
                                </div> 
                            </div>
                            <div class="col-lg-5 col-md-6">
                                <div class="trend-content position-relative text-md-start text-center">
                                    <small><?php echo $pack_list_data['tour_number_of_days'];?></small>

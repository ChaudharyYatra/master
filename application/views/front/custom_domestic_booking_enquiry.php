        ...
        <div class="breadcrumb-outer">
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <h1 class="mb-3">Customized Domestic</h1><h1 class="mt-5">Booking Enquiry</h1>
                            ...
                            <div class="customer-information mb-4">
                                <form class="mb-2" method="post" onsubmit="return custom_enquiry_form()">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                <input type="text" autocomplete="off" placeholder="" class="checkin_date" name="checkin_date" id="checkin_date">

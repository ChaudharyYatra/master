...
<body>
    ...
    <!-- banner starts -->
    <section class="banner flight-banner pt-10 pb-0 overflow-hidden" style="background-image:url(images/testimonial.png);">
        <div class="container">
            <div class="banner-in">
                    ...
                    <div class="col-lg-6 mb-4 position-relative">
                        <div class="flight-slider">
                            <div class="row review-slider1">
                                <div class="col-lg">
                                    <img src="images/flights/3.jpg" alt="" class="rounded">
                                </div>
                                <div class="col-lg">
                                    <img src="images/flights/4.jpg" alt="" class="rounded">
                                </div>
                                <div class="col-lg">
                                    <img src="images/flights/5.jpg" alt="" class="rounded">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="category-main-inner border-t pt-1">
                    <div class="row side-slider">
                        <div class="col-lg-3 col-md-6 my-4">
                            <div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
                                <div class="trending-topic-content">
                                    <img src="images/flights/flight_grid_2.png" class="mb-1 d-inline-block" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 my-4">
                            <div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
                                <div class="trending-topic-content text-center">
                                    <img src="images/flights/flight_grid_3.png" class="mb-1 d-inline-block" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 my-4">
                            <div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
                                <div class="trending-topic-content">
                                    <img src="images/flights/flight_grid_4.png" class="mb-1 d-inline-block" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 my-4">
                            <div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
                                <div class="trending-topic-content">
                                    <img src="images/flights/flight_grid_5.png" class="mb-1 d-inline-block" alt="">
    ...
    <section class="trending pb-17 pt-0" style="background-image:url(images/bg/bg-trans.png); background-position: left; background-size: cover;">
                ...
                <div class="col-lg-5 mb-4">
                    <div class="trend-item1">
                        <div class="trend-image position-relative rounded">
                            <img src="images/flights/3.jpg" alt="image" class="w-100">
                            <div
                ...
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="trend-item1">
                                <div class="trend-image position-relative rounded">
                                    <img src="images/flights/6.jpg" alt="image">
                                    <div
                                        class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                        <div class="trend-content-title">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="trend-item1">
                                <div class="trend-image position-relative rounded">
                                    <img src="images/flights/7.jpg" alt="image">
                                    <div
                                        class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                        <div class="trend-content-title">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="trend-item1">
                                <div class="trend-image position-relative rounded">
                                    <img src="images/flights/8.jpg" alt="image">
                                    <div
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="trend-item1">
                                <div class="trend-image position-relative rounded">
                                    <img src="images/flights/9.jpg" alt="image">
                                    <div
                                        class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                        <div class="trend-content-title">
    ...
    <!-- best tour Starts -->
    <section class="trending pb-6 pt-8">
        <div class="container">
            <div class="row align-items-center justify-content-between mb-6 ">
                <div class="col-lg-7">
                    <div class="section-title text-center text-lg-start">
                        <h4 class="mb-1 theme1">Top Pick</h4>
                        <h2 class="mb-1">Best <span class="theme">Tour Routes</span></h2>
            ...
            <div class="trend-box">
                <div class="row item-slider">
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item rounded">
                            <div class="trend-image position-relative">
                                <img src="images/flights/flight2.jpg" alt="image" class="">
                            </div>
                            <div class="trend-content1 position-relative pt-2 bg-white">
                                <h3 class="mb-1"><a href="flight-grid.html" class="">Tokyo to Male</a></h3>
                                <p class="mb-3">Roundtrip | 09 Jun 2022 - 16 Jun 2022</p>

                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author d-flex align-items-center">
                                        <p class="mb-0">From<span class="theme fw-bold fs-5"> $220.00</span> | Per person</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item rounded">
                            <div class="trend-image position-relative">
                                <img src="images/flights/flight1.jpg" alt="image">
                            </div>
                            <div class="trend-content1 position-relative  pt-2 bg-white">
                                <h3 class="mb-1"><a href="flight-grid.html" class="">New York to London</a></h3>
                                <p class="mb-3">Roundtrip | 09 Jun 2022 - 16 Jun 2022</p>

                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author d-flex align-items-center">
                                        <p class="mb-0">From<span class="theme fw-bold fs-5"> $415.00</span> | Per person</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item rounded">
                            <div class="trend-image position-relative">
                                <img src="images/flights/flight3.jpg" alt="image">
                            </div>
                            <div class="trend-content1 position-relative  pt-2 bg-white">
                                <h3 class="mb-1"><a href="flight-grid.html" class="">Instanbul to Paris</a></h3>
                                <p class="mb-3">Roundtrip | 09 Jun 2022 - 16 Jun 2022</p>

                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author d-flex align-items-center">
                                        <p class="mb-0">From<span class="theme fw-bold fs-5"> $310.00</span> | Per person</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item rounded">
                            <div class="trend-image position-relative">
                                <img src="images/flights/flight4.jpg" alt="image">
                            </div>
                            <div class="trend-content1 position-relative  pt-2 bg-white">
                                <h3 class="mb-1"><a href="flight-grid.html" class="">New York to California</a></h3>
                                <p class="mb-3">Roundtrip | 09 Jun 2022 - 16 Jun 2022</p>
    ...
    <section class="flight-list pt-0">
        <div class="container">
            <div class="section-title mb-6 w-50 mx-auto text-center">
                ...
                <h2 class="mb-1">Find Your <span class="theme">Flight Scheduled</span></h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                    labore.</p>
            </div>
    ...
    <section class="discount-action" style="background-image:url(images/section-bg2.png); background-position:center; background-color: #f1f1f1;"> 
        <div class="container">
    ...
    <section class="trending pb-6" style="background-image: url(images/shape2.png);">
        <div class="container">
            <div class="section-title mb-6 w-75 mx-auto text-center">
                <h4 class="mb-1 theme1">OFFER DEALS</h4>
                <h2 class="mb-1">Flight <span class="theme">Offer Deals</span></h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.
                </p>
            </div>
            <div class="trend-box">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="trend-item rounded box-shadow">
                                    ...
                                    <div class="trend-content p-4 position-relative bg-white">
                                        <h3 class="mb-1"><a href="flight-grid.html" class="">Malaga to Finland</a></h3>
                                        <p class="mb-4">09 Jun 2022 - 16 Jun 2022</p>
                                        <p class=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in
                                            voluptate velit esse cillum</p>
                                        <div class="entry-meta d-flex align-items-center justify-content-between">
                                            <div class="entry-author d-flex align-items-center">
                                                <p class="mb-0">Economy from<br><span class="theme fw-bold fs-5"> $450.00</span> | Per person</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="trend-item rounded box-shadow">
                                    ...
                                    <div class="trend-content p-4 position-relative bg-white">
                                        <h3 class="mb-1"><a href="flight-grid.html" class="">Dubai to New York</a></h3>
                                        <p class="mb-4">09 Jun 2022 - 16 Jun 2022</p>
                                        <p class=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in
                                            voluptate velit esse cillum</p>
                                        <div class="entry-meta d-flex align-items-center justify-content-between">
                                            <div class="entry-author d-flex align-items-center">
                                                <p class="mb-0">Economy from<br><span class="theme fw-bold fs-5"> $340.00</span> | Per person</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="trend-item rounded box-shadow">
                                    ...
                                    <div class="trend-content p-4 position-relative bg-white">
                                        <h3 class="mb-1"><a href="flight-grid.html" class="">Tokyo to Finland</a></h3>
                                        <p class="mb-4">09 Jun 2022 - 16 Jun 2022</p>
                                        <p class=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in
                                            voluptate velit esse cillum</p>
                                        <div class="entry-meta d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-lg-6 col-md-6 mb-4">
                                <div class="trend-item rounded box-shadow">
                                    ...
                                    <div class="trend-content p-4 position-relative bg-white">
                                        <h3 class="mb-1"><a href="flight-grid.html" class="">Male to Franchisco</a></h3>
                                        <p class="mb-4">09 Jun 2022 - 16 Jun 2022</p>
                                        <p class=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in
                                            voluptate velit esse cillum</p>
                                        <div class="entry-meta d-flex align-items-center justify-content-between">
                    ...
                    <div class="col-lg-5">
                        <div class="trend-item1 rounded box-shadow mb-4">
                            <div class="trend-image position-relative">
                                ...
                                <div class="trend-content1 p-4">
                                    <h3 class="mb-1 white"><a href="flight-grid.html" class="white">Dhaka to Dubai</a></h3>
                                    <p class="white mb-4">09 Jun 2022 - 16 Jun 2022</p>

                                    <div class="entry-meta d-flex align-items-center justify-content-between">
                                        <div class="entry-author d-flex align-items-center">
                                            <p class="mb-0 white">Economy from<br><span class="theme1 fw-bold fs-5"> $180.00</span> | Per person</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="color-overlay"></div>
                        ...
                        <div class="trend-item1 rounded box-shadow mb-4">
                            <div class="trend-image position-relative">
                                <img src="images/flights/1.jpg" alt="image" class="">
                                <div class="trend-content1 p-4">
                                    <h3 class="mb-1 white"><a href="flight-grid.html" class="white">New York to California</a></h3>
                                    <p class="white mb-4">09 Jun 2022 - 16 Jun 2022</p>

                                    <div class="entry-meta d-flex align-items-center justify-content-between">
                                        <div class="entry-author d-flex align-items-center">
                                            <p class="mb-0 white">Economy from<br><span class="theme1 fw-bold fs-5"> $220.00</span> | Per person</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="color-overlay"></div>
    ...
    <!-- testomonial start -->
    <section class="testimonial" style="background-image:url(images/flights/1.jpg);">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 pe-lg-4">
                    <div class="testimonial-content">
                        <h5 class="theme mb-1">OFFER DEALS</h5>
                        <h2 class="mb-1">Your Great Destination</h2>
                        <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        <!-- Counter -->
                        <div class="counter-main pt-2">
                            <div class="counter m-0">
                                <div class="row">
                                    <div class="col-lg-6 mb-4">
                                        <div class="counter-item d-flex align-items-center justify-content-between p-4 pb-2 pt-0 bg-white rounded">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        <div class="counter-item d-flex align-items-center justify-content-between p-4 pb-2 pt-0 bg-white rounded">
                                            <div class="counter-content">
                                                <h2 class="value mb-0 theme">520</h2>
                                                <span class="m-0">Client Setisfied</span>
                                            </div>
                                            <i class="fa fa-globe mt-2"></i>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <p class="contact-pac mb-0 d-md-flex align-items-center text-lg-start text-center"><span>Discover the latest offers & news and start planning 
                                            </span><a href="contact.html" class="nir-btn ms-md-3">Contact Us</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 ps-lg-4">
                    <div class="about-slider">
                        <div class="item">
                            <div class="testimonial-item1 rounded bg-white p-5 py-5 box-shadow my-2">
            ...
            <div class="recent-articles-inner">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                            <div class="trend-image">
                                <img src="images/flights/flight8.jpg" alt="image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                            <div class="trend-image">
                                <img src="images/flights/flight7.jpg" alt="image">
                            </div>
                            <div class="trend-content-main p-4 pb-2">
                                <div class="trend-content">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                            <div class="trend-image">
                                <img src="images/flights/flight6.jpg" alt="image">
                            </div>
                            <div class="trend-content-main p-4 pb-2">
                                <div class="trend-content">

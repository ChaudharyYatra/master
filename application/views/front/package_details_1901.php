        ...
        <div class="container">
            ...
            <!-- Button trigger modal -->
                ...
                <div class="download-btn">
                    <!-- <?php //if(!empty($package_details_value['pdf_name'])) { ?><a class="nir-btn" style="color:#fff;" download="" href="<?php //echo base_url(); ?>uploads/package_daywise_program/<?php //echo $package_details_value['pdf_name']; ?>">Download PDF</a><?php //} ?> -->

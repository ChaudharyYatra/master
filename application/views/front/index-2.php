...
<body>
                ...
                <div class="row d-flex align-items-center justify-content-between">
                    ...
                    <div class="col-lg-7 mb-4 ps-lg-4">
                        <div class="about-content text-center text-lg-start mb-4 mt-10">
                            ...
                            <p class="border-b mb-2 pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        ...
                        <div class="trend-item1 rounded box-shadow">
                            <div class="trend-image position-relative">
                                ...
                                <div class="trend-content1 p-4">
                                    ...
                                    <h3 class="mb-1 white"><a href="tour-grid.html" class="white">Tokyo City</a></h3>
                                    <div class="rating-main d-flex align-items-center pb-2">
                                        <div class="rating">
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="col-lg-7 col-md-8">
                                            <div class="trend-content py-3 position-relative">
                                                ...
                                                <h3 class="mb-1"><a href="tour-grid.html">Norwale Lake</a></h3>
                                                <div class="trend-meta border-b pb-2 mb-2">
                                                    <div class="entry-author">
                                                        <i class="icon-calendar"></i>
                                                        <span> 9 Days Tours</span>
                                ...
                                <div class="trend-full bg-white rounded box-shadow overflow-hidden">
                                    <div class="row m-0">
                                        ...
                                        <div class="col-lg-7 col-md-8">
                                            <div class="trend-content py-3 position-relative">
                                                <h5 class="theme mb-0"><i class="flaticon-location-pin"></i> Maldives</h5>
                                                <h3 class="mb-1"><a href="tour-grid.html">Surf Adventure</a></h3>
                                                <div class="trend-meta border-b pb-2 mb-2">
                                                    <div class="entry-author">
                                                        <i class="icon-calendar"></i>
                                                        <span> 9 Days Tours</span>
    ...
    <section class="discount-action pt-0 pb-8" style="background-image: url(images/shape-1.png); background-attachment:unset">
        <div class="container">
            <div class="call-banner1 rounded" style="background-image: url(images/bg/bg4.jpg); background-position:right;">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-6 col-md-6 p-0">
                        <div class="call-banner-inner bg-theme p-5 pt-10 pb-10 my-5 rounded ms-4">
                            ...
                            <h2><a href="tour-single.html" class="white">Explore Your Life, <span class="theme1"> Travel Where You Want!</span></a></h2>
                            <p class="white mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <br><br>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>

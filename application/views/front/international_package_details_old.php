                    ...
                    <div class="single-content">
                        ...
                        <div id="highlight">
                            <div class="description-images mb-4">
                                <img src="<?php echo base_url(); ?>uploads/international_packages/<?php echo $package_details_value['image_name']; ?>" alt="<?php echo $package_details_value['image_name']; ?>" class="w-100 rounded">
                            </div>
                        ...
                        <a href="<?php echo base_url();?>international_packages/booking_enquiry/<?php echo $package_details_value['id']; ?>" class="nir-btn white">Book Now</a>

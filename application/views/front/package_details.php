    ...
    <section class="trending pt-6 pb-0 bg-lgrey overflow-hidden package_details_p_color">
        <div class="tabs-navbar1 bg-white sticky1 bordernone py-3">
            <ul id="tabs" class="nav nav-tabs bordernone mb-0 overflow-visible">				
                ...
                <li class="active"><a data-toggle="tab" href="<?php echo base_url();?>packages/booking_enquiry/<?php echo $package_details_value['id']; ?>" class="bordernone">Enquiry Now</a></li>
            </ul>
        </div>
                ...
                <div  id="iternary" class="accrodion-grp faq-accrodion box-shadow bg-white mb-2 rounded  overflow-hidden" data-grp-name="faq-accrodion">
                    ...
                    <h5 class="text-center">For More details</h5>
                        ...
                        <p class="mb-3 text_justify">
                            <center>
                                <a href="<?php echo base_url();?>packages/booking_enquiry/<?php echo $package_details_value['id']; ?>"><button type="button" class="btn nir-btn mb-2">
                                Click Here
                                </button></a>
                            </center>
                        </p>

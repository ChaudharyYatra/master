                    ...
                    <div class="single-content">
                        <div class="single-full-title border-b mb-2 pb-2">
                            <div class="single-title">
                                <h2 class="mb-0">Dhaka to New York</h2>
                        ...
                        <div class="description-images mb-4 overflow-hidden">
                            <div class="thumbnail-images position-relative">
                                <div class="slider-store rounded overflow-hidden">
                                    <div>
                                       <img src="images/flights/1.jpg" alt="1">
                                    </div>
                                    <div>
                                        <img src="images/flights/2.jpg" alt="1">
                                    </div>
                                    <div>
                                        <img src="images/flights/21.jpg" alt="1">
                                    </div>
                                    <div>
                                        <img src="images/flights/22.jpg" alt="1">
                                    </div>
                                    <div>
                                        <img src="images/flights/23.jpg" alt="1">
                                    </div>   
                                    <div>
                                        <img src="images/flights/24.jpg" alt="1">
                                    </div>
                                </div>

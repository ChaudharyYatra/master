                                ...
                                <li class="dropdown submenu active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="submenu dropdown">
                                            <a href="#" class="dropdown-toggle d-flex align-items-center" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Flights <i class="icon-arrow-right" aria-hidden="true"></i></a> 
                                            <ul class="dropdown-menu">
                ...
                <div class="col-lg-8">
                    <div class="list-results d-flex align-items-center justify-content-between">
                        ...
                        <div class="click-menu d-flex align-items-center justify-content-between">
                            <div class="change-list me-2"><a href="flight-list.html"><i class="fa fa-bars rounded"></i></a></div>
                            <div class="change-grid f-active me-2"><a href="flight-grid.html"><i class="fa fa-th rounded"></i></a></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                <div class="trend-image position-relative">
                                    <img src="images/flights/flight1.jpg" alt="image" class="">
                                    <div class="color-overlay"></div>
                                </div>
                                <div class="trend-content p-4 position-relative bg-white">
                                    <h3 class="mb-1"><a href="flight-detail.html" class="">Malaga to Finland</a></h3>
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                <div class="trend-image position-relative">
                                    <img src="images/flights/flight3.jpg" alt="image" class="">
                                    <div class="color-overlay"></div>
                                </div>
                                <div class="trend-content p-4 position-relative bg-white">
                                    <h3 class="mb-1"><a href="flight-detail.html" class="">Dhaka to sydney</a></h3>
                                    <p class="mb-4">09 Jun 2022 - 16 Jun 2022</p>
                                    <p class=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in
                                        voluptate velit esse cillum</p>
                                    <div class="entry-meta d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                <div class="trend-image position-relative">
                                    <img src="images/flights/flight4.jpg" alt="image" class="">
                                    <div class="color-overlay"></div>
                                </div>
                                <div class="trend-content p-4 position-relative bg-white">
                                    <h3 class="mb-1"><a href="flight-detail.html" class="">New Delhi to Male</a></h3>
                                    <p class="mb-4">09 Jun 2022 - 16 Jun 2022</p>
                                    <p class=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in
                                        voluptate velit esse cillum</p>
                                    <div class="entry-meta d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                ...
                                <div class="trend-content p-4 position-relative bg-white">
                                    <h3 class="mb-1"><a href="flight-detail.html" class="">Tokyo to New York</a></h3>
                                    <p class="mb-4">09 Jun 2022 - 16 Jun 2022</p>
                                    <p class=" border-b pb-2 mb-2">Duis aute irure dolor in reprehenderit in
                                        voluptate velit esse cillum</p>
                                    <div class="entry-meta d-flex align-items-center justify-content-between">

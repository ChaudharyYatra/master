                    ...
                    <div class="single-content">
                        <div id="highlight" class="mb-4">
                            ...
                            <div class="description-images mb-4">
                                <img src="images/trending/trending-large.jpg" alt="" class="w-100 rounded">
                            </div>
                        ...
                        <div class="description mb-2">
                            ...
                            <div class="services-image d-md-flex">
                                <div class="me-md-2 rounded overflow-hidden mb-2"><img src="images/trending/trending5.jpg" alt="" class="w-100"></div>
                                <div class="ms-md-2 rounded overflow-hidden mb-2"><img src="images/trending/trending6.jpg" alt="" class="w-100"></div>
                            </div>              
                        </div>

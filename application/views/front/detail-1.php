...
<body>
    ...
    <!-- Breadcrumb -->
    <div class="page-cover pt-10 pb-10 bg-lgrey border-b">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                    <div class="cover-content text-center text-md-start">
                        <div class="author-detail mb-2">
                            <a href="post-list-1.html" class="tag white bg-theme py-1 px-3 me-2 rounded">#Technology</a>
                            <a href="post-list-1.html" class="tag py-1 px-3"><i class="fa fa-eye"></i> 2500</a>
                        </div>
                        <h1 class="lh-sm">Apple honors eight developers with annual Apple Design Awards.</h1>
                        <div class="author-detail d-flex align-items-center">
                            <span class="me-3"><a href="post-list-1.html"><i class="fa fa-clock"></i> Posted On : 12 May 2021</a></span>
                            <span class="me-3"><a href="post-list-1.html"><i class="fa fa-user"></i> Jack Richard</a></span>
                            <span><a href="post-list-1.html"><i class="fa fa-comments"></i> 50</a></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="box-shadow p-3 position-relative">
                        <img src="images/trending/trending6.jpg" alt="Image" class="w-100 rounded">
                    ...
                    <div class="blog-single">
                        ...
                        <div class="blog-single-in d-md-flex align-items-center mb-4 text-center text-md-start">
                            <div class="blog-date me-4">
                                <div class="date text-center bg-theme p-5 py-4 rounded">
                                    <h2 class="day mb-0 white">11</h2>
                                    <div class="month white">May</div>
                                </div>
                            </div>
                            <div class="blog-single-in-cont w-75">
                                <div class="blog-content">
                                    <h2 class="blog-title mb-0"><a href="#" class="">Winners are recognized for outstanding app design</a></h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blog-wrapper">
                            <div class="blog-content">
                                <div class="blog-imagelist mb-3">
                                    <img src="images/bg/bg3.jpg" alt="image" class="rounded">
                                </div>
                                <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipis Vi ales elit vitae lo bortis faucibus. Lorem ipsum dolor sit amet, conse dolor sit amet, consectetu ctetur adipis Viales. Lorem ipsum dolor sit amet, cons sit amet, consectetur adi ectetur adipis Vi.<br><br>
                                        ...
                                        <div class="tab-content" id="postsTabContent1">
                                            ...
                                            <div aria-labelledby="popular-tab" class="tab-pane fade active show" id="popular" role="tabpanel">
                                                    <article class="post mb-3 border-b pb-3">
                                                        <div class="s-content d-flex align-items-center justify-space-between">
                                                            <div class="sidebar-image w-25 me-3">
                                                                <a href="#"><img src="images/trending/trending1.jpg" alt=""></a>
                                                            </div>
                                                    ...
                                                    <article class="post border-b pb-3 mb-3">
                                                        <div class="s-content d-flex align-items-center justify-space-between">
                                                            <div class="sidebar-image w-25 me-3">
                                                                <a href="#"><img src="images/trending/trending2.jpg" alt=""></a>
                                                            </div>
                                                            <div class="content-list w-75">
                                                    ...
                                                    <article class="post border-b pb-3">
                                                        <div class="s-content d-flex align-items-center justify-space-between">
                                                            <div class="sidebar-image w-25 me-3">
                                                                <a href="#"><img src="images/trending/trending4.jpg" alt=""></a>
                                                            </div>
                                                            <div class="content-list w-75">
                                                                <h5 class="mb-1"><a href="detail-1.html">15 Unheard Ways To Achieve Greater Walker</a></h5>
                                            ...
                                            <div aria-labelledby="recent-tab" class="tab-pane fade" id="recent" role="tabpanel">
                                                <article class="post mb-3 border-b pb-3">
                                                    <div class="s-content d-flex align-items-center justify-space-between">
                                                        <div class="sidebar-image w-25 me-3">
                                                            <a href="#"><img src="images/trending/trending5.jpg" alt=""></a>
                                                        </div>
                                                        <div class="content-list w-75">
                                                ...
                                                <article class="post border-b pb-3 mb-3">
                                                    <div class="s-content d-flex align-items-center justify-space-between">
                                                        <div class="sidebar-image w-25 me-3">
                                                            <a href="#"><img src="images/trending/trending6.jpg" alt=""></a>
                                                        </div>
                                                        <div class="content-list w-75">
                                                ...
                                                <article class="post border-b pb-3">
                                                    <div class="s-content d-flex align-items-center justify-space-between">
                                                        <div class="sidebar-image w-25 me-3">
                                                            <a href="#"><img src="images/trending/trending3.jpg" alt=""></a>
                                                        </div>
                                                        <div class="content-list w-75">
    ...
    <!-- top deal starts -->
    <section class="top-post pt-0 pb-6">
        <div class="container"> 

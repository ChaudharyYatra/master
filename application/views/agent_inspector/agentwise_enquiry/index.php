                  ...
                  <tr>
                    ...
                    <td><?php echo date("Y-m-d",strtotime($info['created_at'])); ?></td>
                      ...
                      <?php        
                        ...
                        ?>
                        <a href="<?php echo $module_url_path; ?>/followup_list/<?php echo $info['iid'].'/'.$info['enquiry_type']; ?>">
                          <button type="button" class="btn btn-primary">Not Interested</button></a>
                      <!-- <h5 style="color:red;">Not Interested</h5> -->
                      <?php 
                            } else{
                          ?>
                          <a href="<?php echo $module_url_path; ?>/followup_list/<?php echo $info['iid'].'/'.$info['enquiry_type']; ?>">
                          <button type="button" class="btn btn-primary">Followup</button></a>

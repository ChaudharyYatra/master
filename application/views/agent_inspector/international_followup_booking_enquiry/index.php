...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>International Booking Followup List</h1>
          </div>
          <div class="col-sm-6">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      ?>
                       ...
                       <a href="<?php echo $module_url_path; ?>/international_followup_list/<?php $aid=base64_encode($info['id']); echo rtrim($aid, '='); ?>"><button type="button" class="btn btn-primary">Status</button></a>
                    <?php        
                          }else{
                      ?>

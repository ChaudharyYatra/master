                  ...
                  <tr>
                   ...
                   <td>
                      <?php
                          ...
                          {
                      ?>
                      <!--<img src=<?php //echo base_url(); ?>uploads\do_not_delete\follow_black.png height="30%" width="30%" alt disabled></img>-->
                      <h6>Followup Already Taken</h6>
                      <?php        
                          }else{
                      ?>
                      <!--<a data-bs-toggle="modal" data-bs-target="#exampleModal" class="international_enq_id" data-bs-whatever="Form" inter-data-enq-id="<?php //echo $enq_id;?>"><img src=<?php //echo base_url(); ?>uploads\do_not_delete\follow.png height="30%" width="30%" alt></img></a>-->
                      <a data-bs-toggle="modal" data-bs-target="#exampleModal" class="international_enq_id" data-bs-whatever="Form" inter-data-enq-id="<?php echo $enq_id;?>">Click Here</a>
                    </td>
                     <?php } ?>

                    <td>
                      <a href="<?php echo $module_url_path_international_followup;?>/index/<?php echo $info['id']; ?>">Click Here</a>
                    </td>

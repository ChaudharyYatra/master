              ...
              { ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="<?php echo $module_url_path;?>/details/<?php echo $info['ceid']; ?>"><button type="button" class="btn btn-primary btn-sm btn_follow" class="dropdown-item">View</button></a>
                    </td>

                    <td>
                    <a href="<?php echo $module_url_path_followup;?>/custom_followup_list/<?php echo $info['ceid']; ?>"><button type="button" class="btn btn-primary btn-sm btn_follow" class="dropdown-item">Followup</button></a>
                    </td>
                  </tr>

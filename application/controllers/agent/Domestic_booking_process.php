...
class Domestic_booking_process extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_panel_slug')."/domestic_booking_process";
        ...
        $this->module_title       = "Domestic Booking Process";
        $this->module_title_followup       = "Domestic Booking Enquiry Followup";
        $this->module_url_slug    = "domestic_booking_process";
        $this->module_view_folder = "domestic_booking_process/";
        $this->arr_view_data = [];
	 }
            ...
            // print_r($_REQUEST); die;
             ...
             { 
                ...
                //  $id = $this->db->inserted_id();
                 ...
                 echo $agent_name=$agent_data_email['agent_name'];
                   die;             
                 if($inserted_id > 0)
                 {

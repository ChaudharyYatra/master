...
class General_enquiry_followup extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_panel_slug')."/general_enquiry_followup";
        $this->module_url_booking_basic_info    =  base_url().$this->config->item('agent_panel_slug')."/booking_basic_info";
        $this->module_url_path_booking_enq    =  base_url().$this->config->item('agent_panel_slug')."/contact_general_enquiry";

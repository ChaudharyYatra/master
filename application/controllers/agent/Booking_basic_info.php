...
class Booking_basic_info extends CI_Controller {
    ...
    {  
        ...
        $fields = "packages.*,package_date.journey_date,package_date.id as p_date_id,bus_seat_book.package_id";
                ...
                $hotel_type  = $this->input->post('hotel_type');
                 ...
                 $arr_insert = array(
                    ...
                    $arr_where     = array("domestic_enquiry_id" => $iid);
                     ...
                     $enq_arr_update = array(
                        'seat_count'   =>   $seat_count
                     );
                     $enq_arr_where     = array("id" => $domestic_enquiry_id);
                     $this->master_model->updateRecord('booking_enquiry',$enq_arr_update,$enq_arr_where);

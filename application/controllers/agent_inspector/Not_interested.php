...
class Not_interested extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_inspector_panel_slug')."agent_inspector/not_interested";
        $this->module_url_path_booking_enq    =  base_url().$this->config->item('agent_inspector_panel_slug')."agent_inspector/booking_enquiry";

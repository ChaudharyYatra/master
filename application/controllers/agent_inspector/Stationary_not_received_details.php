...
class Stationary_not_received_details extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_inspector_panel_slug')."agent_inspector/stationary_not_received_details";
        $this->module_title       = "Stationary Inprocess Orders ";
        $this->module_url_slug    = "stationary_not_received_details";
        $this->module_view_folder = "stationary_not_received_details/";
        $this->arr_view_data = [];
	 }

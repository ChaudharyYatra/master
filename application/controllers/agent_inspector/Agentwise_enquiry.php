...
class Agentwise_enquiry extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_inspector_panel_slug')."agent_inspector/agentwise_enquiry";
	$this->module_url_path_back    =  base_url().$this->config->item('agent_inspector_panel_slug')."agent_inspector/agent";
	...
	{	    
        ...
        $rid = $this->session->userdata('agent_inspector_sess_id');
        ...
        public function followup_list($iid,$enquiry_type)
	{
	        ...
	        $i=base64_decode($iid);
                ...
                { 
                        ...
                        foreach($arr_data_booking_enquiry as $agent_data){
                                $a_enquiry= $agent_data['agent_id'];
                ...
                $this->arr_view_data['listing_page']    = 'yes';
                $this->arr_view_data['arr_data']        = $arr_data;
                $this->arr_view_data['a_enquiry']        = $a_enquiry;

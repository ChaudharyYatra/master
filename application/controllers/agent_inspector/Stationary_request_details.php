...
class Stationary_request_details extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_inspector_panel_slug')."agent_inspector/stationary_request_details";
        $this->module_title       = "Stationary Requested Orders ";
        $this->module_url_slug    = "stationary_request_details";
        $this->module_view_folder = "stationary_request_details/";
        $this->arr_view_data = [];
	 }

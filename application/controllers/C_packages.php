...
class C_packages extends CI_Controller {
    ...
    public function c_booking_enquiry()
    {
        ...
        $data = array('middle_content' => 'c_booking_enquiry',
                        ...
                        'page_title'    => 'Custom Booking Enquiry',
						);

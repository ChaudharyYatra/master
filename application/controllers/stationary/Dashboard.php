...
class Dashboard extends CI_Controller{
	...
	public function index()
	{
                ...
                $arr_data['stationary_order_count'] = count($stationary_order);
                ...
                $arr_data['stationary_order_today_count'] = count($stationary_order_today);

                $this->db->where('is_deleted','no');
                $this->db->where('order_status','completed');
                $stationary_order_status = $this->master_model->getRecords('stationary_order');
                $arr_data['stationary_order_status_count'] = count($stationary_order_status);

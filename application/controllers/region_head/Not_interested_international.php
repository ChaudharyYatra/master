...
class Not_interested_international extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('region_head_panel_slug')."region_head/not_interested_international";
        $this->module_url_path_inter_booking_enq    =  base_url().$this->config->item('region_head_panel_slug')."region_head/international_booking_enquiry";

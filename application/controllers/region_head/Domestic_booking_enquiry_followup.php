...
class Domestic_booking_enquiry_followup extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('region_head_panel_slug')."/domestic_booking_enquiry_followup";
        $this->module_url_booking_basic_info    =  base_url().$this->config->item('region_head_panel_slug')."/booking_basic_info";
        $this->module_url_path_booking_enq    =  base_url().$this->config->item('region_head_panel_slug')."/booking_enquiry";
     ...
     public function index($i)
     {
        ...
        $this->db->where('region_head_id',$id);
        $this->db->where('ftaken_by','region_head');

...
class Region_head extends CI_Controller{
	...
	{  
        $fields = "region_head.*,agent.fld_agency_name,agent.booking_center,agent.password as a_password,department.department,agent.id as a_id";
    ...
    {   
        ...
        if($this->input->post('submit'))
        {
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                $agent_region_check = $this->master_model->getRecords('region_head',array('is_deleted'=>'no','agent_region'=>trim($this->input->post('agent_region'))));
                if(count($agent_region_check)==0){
                ...
                $this->session->set_flashdata('error_message',"Agent Region-head already exist.");
            }  
        }
        }

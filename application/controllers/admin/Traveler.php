...
class Traveler extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."/traveler";
        $this->module_title       = "User";
        $this->module_url_slug    = "traveler";
        $this->module_view_folder = "traveler/";    
  ...
  public function active_inactive($id,$type)
    {
        ...
        {   
            ...
            if($this->master_model->updateRecord('travelers',$arr_update,array('id' => $id)))
            {
    ...
    public function delete($id)
    {
        ...
        {   
            ...
            if($this->master_model->updateRecord('travelers',$arr_update,$arr_where))
            {

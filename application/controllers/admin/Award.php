...
class Award extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."/award";
        $this->module_title       = "Award";
        $this->module_url_slug    = "award";
        $this->module_view_folder = "award/";    
	...
	public function index()
	{
        ...
        $arr_data = $this->master_model->getRecords('award');
    ...
    {   
        ...
        {        
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                $config['upload_path']   = './uploads/award/';
                ...
                $inserted_id = $this->master_model->insertRecord('award',$arr_insert,true);
        ...
        $this->db->order_by('id','desc');
        $this->db->where('is_deleted','no');
        $award_data = $this->master_model->getRecords('award');

        $this->arr_view_data['action']          = 'add';
        $this->arr_view_data['award_data'] = $award_data;
  ...
  public function active_inactive($id,$type)
    {
	  $id=base64_decode($id);
        ...
        {   
            ...
            if($this->master_model->updateRecord('award',$arr_update,array('id' => $id)))
            {
    ...
    public function edit($id)
    {
     ...
     public function delete($id)
     {
         ...
         {   
             ...
             if(!empty($arr_data))
            {
                $del_img_name = base_url().'uploads/award/'.$arr_data[0]['image_name'];
            }
             $arr_where = array("id" => $id);
                  
             if($this->master_model->deleteRecord('award',$arr_where))
             {
                 if($del_img_name!='') unlink('./uploads/award/'.$arr_data[0]['image_name']);

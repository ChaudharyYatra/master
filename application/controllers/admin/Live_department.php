...
class Live_department extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."/live_department";
        $this->module_title       = "Department";
        $this->module_url_slug    = "live_department";
        $this->module_view_folder = "live_department/";    
	...
	{  
        ...
        $arr_data = $this->master_model->getRecords('live_department');
    ...
    {   
        ...
        if($this->input->post('submit'))
        {
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                $this->db->where('is_deleted','no');
                $department_exist_data = $this->master_model->getRecords('live_department');
                ...
                $inserted_id = $this->master_model->insertRecord('live_department',$arr_insert,true);
  ...
  public function active_inactive($id,$type)
    {
        ...
        {   
            ...
            if($this->master_model->updateRecord('live_department',$arr_update,array('id' => $id)))
            {
    ...
    public function delete($id)
    {
        ...
        {   
            ...
            if($this->master_model->updateRecord('live_department',$arr_update,$arr_where))
            {
            ...
            if($this->input->post('submit'))
            {
                ...
                if($this->form_validation->run() == TRUE)
                {
                   $department = trim($this->input->post('department'));
                    ...
                    $arr_where     = array("id" => $id);
                   $this->master_model->updateRecord('live_department',$arr_update,$arr_where);
                    if($id > 0)
                    {

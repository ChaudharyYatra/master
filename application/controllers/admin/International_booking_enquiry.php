            ...
            if($this->form_validation->run() == true){
                ...
                //     die;
                    ...
                    if($agent_email!=''){
                        ...
                        $successMsg = 'Enquiry imported successfully. Total Rows ('.$rowCount.') | Inserted ('.$insertCount.') | Not Inserted ('.$notAddCount.')';
                        $this->session->set_userdata('success_msg', $successMsg);
                    }

                    if($successMsg !='')
                            {    
                                $this->session->set_flashdata('success_message',$successMsg);

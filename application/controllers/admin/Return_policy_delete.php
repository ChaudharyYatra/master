...
class Return_policy extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."/return_policy";
        $this->module_title       = "Return Policy";
        $this->module_url_slug    = "return_policy";
        $this->module_view_folder = "return_policy/";    
	...
	{  
        ...
        $arr_data = $this->master_model->getRecords('return_policy');
    ...
    {   
        ...
        if($this->input->post('submit'))
        {
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                $inserted_id = $this->master_model->insertRecord('return_policy',$arr_insert,true);
  ...
  public function active_inactive($id,$type)
    {
        ...
        {   
            ...
            if($this->master_model->updateRecord('return_policy',$arr_update,array('id' => $id)))
            {
    ...
    public function delete($id)
    {
        ...
        {   
            ...
            if($this->master_model->updateRecord('return_policy',$arr_update,$arr_where))
            {
            ...
            if($this->input->post('submit'))
            {
                ...
                if($this->form_validation->run() == TRUE)
                {
                   $return_policy = trim($this->input->post('return_policy'));
                    ...
                    $arr_where     = array("id" => $id);
                   $this->master_model->updateRecord('return_policy',$arr_update,$arr_where);
                    if($id > 0)
                    {

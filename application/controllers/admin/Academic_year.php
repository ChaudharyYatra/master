...
class Academic_year extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('admin_panel_slug')."/academic_year";
        $this->module_title       = "Academic Year";
        $this->module_url_slug    = "academic_year";
        $this->module_view_folder = "academic_year/";    

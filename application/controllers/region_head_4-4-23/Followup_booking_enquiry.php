...
class Followup_booking_enquiry extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('region_head_panel_slug')."region_head/followup_booking_enquiry";
        ...
        public function followup_list($id)
	{
		$i=base64_decode($id);
                ...
                $record = array();
		$fields = "booking_enquiry.*,agent.agent_name,agent.booking_center,agent.department,department.department,booking_enquiry.created_at c_date,agent.department";
                $this->db->where('booking_enquiry.is_deleted','no');

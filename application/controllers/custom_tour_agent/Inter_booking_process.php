...
class Inter_booking_process extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('agent_panel_slug')."/Inter_booking_process";
        ...
        $this->module_title       = "International Booking Process";
        $this->module_url_slug    = "inter_booking_process";
        $this->module_view_folder = "inter_booking_process/";
        $this->arr_view_data = [];
	 }
     ...
     public function index()
     {
        ...
        $this->db->where('international_booking_enquiry.booking_process','yes');
        ...
        $this->arr_view_data['followup_reason_data'] = $followup_reason_data;
         ...
         $this->arr_view_data['inter_booking_basic_info'] = $this->inter_booking_basic_info;

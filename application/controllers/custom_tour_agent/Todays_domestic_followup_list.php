...
class Todays_domestic_followup_list extends CI_Controller {
	...
	function __construct() {
        ...
        $this->module_url_path    =  base_url().$this->config->item('custom_tour_agent_panel_slug')."custom_tour_agent/todays_domestic_followup_list";
        $this->module_title       = "Todays Custom Domestic Followup List";
        $this->module_url_slug    = "todays_domestic_followup_list";
        $this->module_view_folder = "todays_domestic_followup_list/";
        $this->arr_view_data = [];
	 }
     ...
     public function index()
     {
        ...
        $record = array();
        $fields = "custom_domestic_followup.*,custom_domestic_booking_enquiry.full_name,custom_domestic_booking_enquiry.created_at";
        $this->db->where('custom_domestic_followup.is_deleted','no');
        $this->db->where('next_followup_date',$today);
        // $this->db->where('custom_domestic_booking_enquiry.agent_id',$id);
        $this->db->join("custom_domestic_booking_enquiry", 'custom_domestic_followup.booking_enquiry_id=custom_domestic_booking_enquiry.id','left');

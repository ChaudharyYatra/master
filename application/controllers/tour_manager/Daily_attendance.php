...
class Daily_attendance extends CI_Controller {
	...
	function __construct() {
        ...
        {  
            ...
            $package_arr_data = $this->master_model->getRecords('asign_tour_manager',array('asign_tour_manager.is_deleted'=>'no'),$fields);
            // print_r($arr_data); die;
        ...
        if($this->input->post('submit'))
        {
         ...
         $this->arr_view_data['package_arr_data']        = $package_arr_data;

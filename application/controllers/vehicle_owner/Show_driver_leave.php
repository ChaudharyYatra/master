...
class Show_driver_leave extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('vehicle_owner_panel_slug')."vehicle_owner/show_driver_leave";
        ...
        $this->module_title       = "Driver Leave";
        $this->module_url_slug    = "show_driver_leave";
        $this->module_view_folder = "show_driver_leave/";    

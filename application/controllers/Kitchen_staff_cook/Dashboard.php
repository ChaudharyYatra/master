...
class Dashboard extends CI_Controller{
	...
	public function __construct()
	{
        ...
        $this->module_url_path    =  base_url().$this->config->item('kitchen_staff_cook_panel_slug')."/dashboard";
        $this->module_url_path_followup_list    =  base_url().$this->config->item('kitchen_staff_cook_panel_slug')."/todays_domestic_followup_list";
        $this->module_url_path_inter_followup_list    =  base_url().$this->config->item('kitchen_staff_cook_panel_slug')."/todays_international_followup_list";
